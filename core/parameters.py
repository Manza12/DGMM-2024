...
VERTICAL_THINNING_ITERATIONS = 10  # no unit
HORIZONTAL_THINNING_ITERATIONS = 10  # no unit
RECONSTRUCTION_EROSION_ITERATIONS = 10  # no unit

# Sinusoids parameters
MIN_AMPLI_DB = -100  # dB
FADE_IN = 0.005  # s
FADE_OUT = 0.01  # s
MIN_LENGTH_SINUSOIDS = 0.050  # s
FILTER_SINUSOIDS = (3, 0.05)  # (order, cutoff) or None

# Transient parameters
MIN_LENGTH_TRANSIENT = 50  # Hz
